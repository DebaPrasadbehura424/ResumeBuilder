...
function ResumeNavBar() {
  ...
  async function handleProfileImage(e) {
    ...
    try {
      await axios.post("http://localhost:7878/api/resumer/upload", formData);
      getUser(); // Refresh image after upload
    } catch (error) {
        ...
        <div className="flex items-center space-x-2">
          ...
          >
            <path
              ...
              strokeWidth="2"
              d="M12 8c-1.657 0-3 1.343-3 3s1.343 3 3 3 3-1.343 3-3-1.343-3-3-3zm0-6C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z"
            />
          </svg>
          <span className="text-xl font-bold">Resu-Me</span>
        </div>
